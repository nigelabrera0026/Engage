<?php 
    ...
    // Debug for session and cookie
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        $user = $_POST['email'];
        $pwd = $_POST['pwd'];

        $query = "SELECT genre_id FROM genres WHERE gen";
    ...
    Scenario: 
    $error[] = $song_name_empt;  false
    $error[] = $song_genre_empt; false
    $error[] = $song_img_empt;   true
    $error[] = $song_file_empt;  true
    ...
    //             // Returns 1 if true.
    //             $error[] = $song_name_empt;
    //             $error[] = $song_genre_empt;
    //             $error[] = $song_img_empt;
    //             $error[] = $song_file_empt;
    ...
    //                 // TODO FIXME ANALYZATION BEFORE EXECUTION
